...
public class InvestorDailyInfoFragment extends Fragment implements NavController.OnDestinationChangedListener {



    private FragmentInvestorDailyInfoBinding binding;
    ...
    private final String  plantName = InvestorHomeFragment.PLANT_NAME;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentInvestorDailyInfoBinding.inflate(inflater,container,false);
